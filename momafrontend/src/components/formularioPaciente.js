...
function MostrarBotones(props) {
  if(props.funcion == 'Agregar'){
    return(
      <Fragment>
        <div className='col'>
    ...
    return(
      <Fragment>
        <div className='col'><button type="submit" className="btn btn-warning">Guardar Cambios</button></div>
        <div className='col'><button type="submit" className="btn btn-danger">Eliminar Paciente</button></div>
      </Fragment>
    );
  }
}
...
class formularioPaciente extends Component {
    ...
    componentDidMount(){
      if(this.props.datosEnviados != null){
        this.MostrarNotNullInputs(this.props.datosEnviados);
        this.setState({
          paciente:{
    ...
    EnviarDatos = (e) => {
      e.preventDefault();
      this.props.MandarDataPadre(this.state)
    }

    AgregarQuitarEnfermedades = e => {
    ...
    MostrarOcultarInputs = (valor,id1,id2) => {
        if(valor == 'Si' ){
            if(id2 != null){
    ...
    render() {
        ...
        return (
          <Fragment>
            <form autoComplete="off" onSubmit={this.EnviarDatos}>
              ...
              <div className='form-row'>
                ...
                <div className="custom-control custom-radio custom-control-inline">
                  <input type="radio" className="custom-control-input" id="HospitalizadoRID" name="HospitalizadoRN" value='Si' onChange={ e => {this.MostrarOcultarInputs(e.target.value,'PorqueHospitalizadoID','DondeHospitalizadoID')}} required/>
                  <label className="custom-control-label" htmlFor="HospitalizadoRID">Si</label>
                </div>
                <div className="custom-control custom-radio custom-control-inline">
                  <input type="radio" className="custom-control-input" id="Hospitalizado2RID" name="HospitalizadoRN" value='No' onChange={ e => {this.MostrarOcultarInputs(e.target.value,'PorqueHospitalizadoID','DondeHospitalizadoID')}}/>
              ...
              <div className='form-row'>
                ...
                <div className="custom-control custom-radio custom-control-inline">
                  <input type="radio" className="custom-control-input" id="AtencionMedicaRID" name="AtencionMedicaRN"  value='Si' onChange={ e => {this.MostrarOcultarInputs(e.target.value,'AtenMediPorqueID','AtenMediDondeID')}} required/>
                  <label className="custom-control-label" htmlFor="AtencionMedicaRID">Si</label>
                </div>
                <div className="custom-control custom-radio custom-control-inline">
                  <input type="radio" className="custom-control-input" id="AtencionMedica2RID" name="AtencionMedicaRN"  value='No' onChange={ e => {this.MostrarOcultarInputs(e.target.value,'AtenMediPorqueID','AtenMediDondeID')}}/>
              ...
              <div className='form-row'>
                ...
                <div className="custom-control custom-radio custom-control-inline">
                  <input type="radio" className="custom-control-input" id="medicAlerRID" name="medicAlerRN"  value='Si' onChange={ e => {this.MostrarOcultarInputs(e.target.value,'medicAler',null)}} required/>
                  <label className="custom-control-label" htmlFor="medicAlerRID">Si</label>
                </div>
                <div className="custom-control custom-radio custom-control-inline">
                  <input type="radio" className="custom-control-input" id="medicAler2RID" name="medicAlerRN"  value='No' onChange={ e => {this.MostrarOcultarInputs(e.target.value,'medicAler',null)}}/>
              ...
              <div className='list-group pb-2 pt-2'>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB1"  value="Cardiopatia" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB1">Cardiopatía</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB2" value="Fiebre Reumatica" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB2">Fiebre Reumática</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB3" value="Artritis" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB3">Artritis</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB4" value="Tuberculosis" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB4">Tuberculosis</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB5" value="Anemia" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB5">Anemia</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB6" value="Epilepsia" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB6">Epilepsia</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB7" value="Lesiones Cardiacas" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB7">Lesiones Cardiacas</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB8" value="Tratamiento psiquico" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB8">Tratamiento psiquico</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB9" value="Marcapasos" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB9">Marcapasos</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB10" value="Hepatitis" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB10">Hepatitis</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB11" value="Tratamiento oncologico" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB11">Tratamiento oncológico</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB12" value="Hipertension arterial" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB12">Hipertensión arterial</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB13" value="Diabetes" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB13">Diabetes</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB14" value="Apoplejia" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB14">Apoplejía</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB15" value="Accidentes Vasculares" onChange={this.AgregarQuitarEnfermedades}/>
                  <label className="form-check-label" htmlFor="enfTenidasCB15">Accidentes Vasculares</label>
                </div>
                <div className="form-check form-check-inline">
                  <input className="form-check-input" type="checkbox" id="enfTenidasCB16" value="Perdida de peso" onChange={this.AgregarQuitarEnfermedades}/>
              ...
              <div className='form-row'>
                ...
                <div className="custom-control custom-radio custom-control-inline">
                  <input type="radio" className="custom-control-input" id="OtraEnfTenidasRID" name="OtraEnfTenidasRN"  value='Si' onChange={ e => {this.MostrarOcultarInputs(e.target.value,'OtraEnfTenidasID',null)}} required/>
                  <label className="custom-control-label" htmlFor="OtraEnfTenidasRID">Si</label>
                </div>
                <div className="custom-control custom-radio custom-control-inline">
                  <input type="radio" className="custom-control-input" id="OtraEnfTenidas2RID" name="OtraEnfTenidasRN"  value='No' onChange={ e => {this.MostrarOcultarInputs(e.target.value,'OtraEnfTenidasID',null)}}/>
              ...
              <div className='form-row'>
                ...
                <div className="custom-control custom-radio custom-control-inline">
                  <input type="radio" className="custom-control-input" id="medTomadasActuRID" name="medTomadasActuRN"  value='Si' onChange={ e => {this.MostrarOcultarInputs(e.target.value,'medTomadasActuID',null)}} required/>
                  <label className="custom-control-label" htmlFor="medTomadasActuRID">Si</label>
                </div>
                <div className="custom-control custom-radio custom-control-inline">
                  <input type="radio" className="custom-control-input" id="medTomadasActu2RID" name="medTomadasActuRN"  value='No' onChange={ e => {this.MostrarOcultarInputs(e.target.value,'medTomadasActuID',null)}}/>
              ...
              <div className='row'>
                <MostrarBotones funcion = {this.props.Funcionalidad}></MostrarBotones>
              </div>
            </form>
          </Fragment>
        )
